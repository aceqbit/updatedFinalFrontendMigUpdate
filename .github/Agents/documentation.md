...
- The Documentation Agent should also verify that the final `report/migration_report.md` documents the checkpoint commit hash created by the Implementation Agent.
