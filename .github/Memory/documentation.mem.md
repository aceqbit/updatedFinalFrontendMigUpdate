...
- Documentation memories should include `git_checkpoint_message` and `git_checkpoint_commit` for every documented checkpoint. Do not document tags or branches as the authoritative migration checkpoint.
