...
- Implementation memories must store the authoritative checkpoint as `git_checkpoint_commit` and `git_checkpoint_message`. Never rely on tags or branches as checkpoints; treat them as labels only.
