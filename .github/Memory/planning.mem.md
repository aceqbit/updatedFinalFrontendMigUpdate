...
- For planning-related memories, record the checkpoint as a commit: include `git_checkpoint_message` and `git_checkpoint_commit` (short hash). Do NOT use or recommend creating lightweight tags as the authoritative checkpoint.
